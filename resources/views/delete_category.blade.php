    ...
    <div class="row justify-content-center">
        <div class="col">
            ...
            <div class="col card p-5 text-center">
                ...
                <h4 class="text-primary mb-3">{{ $category->nome }}</h4>
                <p class="text">Confirma a exclusão dessa categoria?</p>
                <div class="mt-3">
                    <a href="{{ route('home') }}" class="btn btn-primary px-5 m-2"><i
                            class="fa-solid fa-xmark me-2"></i>Não</a>
                    <a href="{{ route('delete.category.confirm', \App\Services\Operations::encryptId($category->id)) }}"
